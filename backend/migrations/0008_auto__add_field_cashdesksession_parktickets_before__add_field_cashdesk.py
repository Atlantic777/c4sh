...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CashdeskSession.day_passes_after'
        db.alter_column('backend_cashdesksession', 'day_passes_after', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CashdeskSession.full_passes_after'
        db.alter_column('backend_cashdesksession', 'full_passes_after', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CashdeskSession.day_passes_after'
        db.alter_column('backend_cashdesksession', 'day_passes_after', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'CashdeskSession.full_passes_after'
        db.alter_column('backend_cashdesksession', 'full_passes_after', self.gf('django.db.models.fields.IntegerField')(default=0))
