...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HonoraryMember.membership_numer'
        db.delete_column('backend_honorarymember', 'membership_numer')

        # Adding field 'HonoraryMember.membership_number'
        db.add_column('backend_honorarymember', 'membership_number',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HonoraryMember.membership_numer'
        db.add_column('backend_honorarymember', 'membership_numer',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=50),
                      keep_default=False)

        # Deleting field 'HonoraryMember.membership_number'
        db.delete_column('backend_honorarymember', 'membership_number')
    ...
    models = {
        ...
        'backend.honorarymember': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'membership_number': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'backend.ticket': {
