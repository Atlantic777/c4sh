...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CashdeskSession.notes'
        db.add_column('backend_cashdesksession', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'CashdeskSession.valid_until'
        db.alter_column('backend_cashdesksession', 'valid_until', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 17, 0, 0)))

        # Changing field 'CashdeskSession.valid_from'
        db.alter_column('backend_cashdesksession', 'valid_from', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 5, 17, 0, 0)))

    def backwards(self, orm):
        # Deleting field 'CashdeskSession.notes'
        db.delete_column('backend_cashdesksession', 'notes')


        # Changing field 'CashdeskSession.valid_until'
        db.alter_column('backend_cashdesksession', 'valid_until', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'CashdeskSession.valid_from'
        db.alter_column('backend_cashdesksession', 'valid_from', self.gf('django.db.models.fields.DateTimeField')(null=True))
