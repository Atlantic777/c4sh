...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CashdeskSession.parktickets_before'
        db.delete_column('backend_cashdesksession', 'parktickets_before')

        # Deleting field 'CashdeskSession.day_passes_after'
        db.delete_column('backend_cashdesksession', 'day_passes_after')

        # Deleting field 'CashdeskSession.full_passes_after'
        db.delete_column('backend_cashdesksession', 'full_passes_after')

        # Deleting field 'CashdeskSession.day_passes_before'
        db.delete_column('backend_cashdesksession', 'day_passes_before')

        # Deleting field 'CashdeskSession.full_passes_before'
        db.delete_column('backend_cashdesksession', 'full_passes_before')

        # Deleting field 'CashdeskSession.parktickets_after'
        db.delete_column('backend_cashdesksession', 'parktickets_after')


    def backwards(self, orm):
        # Adding field 'CashdeskSession.parktickets_before'
        db.add_column('backend_cashdesksession', 'parktickets_before',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CashdeskSession.day_passes_after'
        db.add_column('backend_cashdesksession', 'day_passes_after',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CashdeskSession.full_passes_after'
        db.add_column('backend_cashdesksession', 'full_passes_after',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CashdeskSession.day_passes_before'
        db.add_column('backend_cashdesksession', 'day_passes_before',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CashdeskSession.full_passes_before'
        db.add_column('backend_cashdesksession', 'full_passes_before',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CashdeskSession.parktickets_after'
        db.add_column('backend_cashdesksession', 'parktickets_after',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
