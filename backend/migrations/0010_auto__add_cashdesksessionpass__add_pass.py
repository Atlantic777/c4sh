...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CashdeskSessionPass'
        db.create_table('backend_cashdesksessionpass', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pass_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.Pass'])),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.CashdeskSession'])),
            ('before_session', self.gf('django.db.models.fields.IntegerField')()),
            ('after_session', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('backend', ['CashdeskSessionPass'])

        # Adding model 'Pass'
        db.create_table('backend_pass', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('backend', ['Pass'])


    def backwards(self, orm):
        # Deleting model 'CashdeskSessionPass'
        db.delete_table('backend_cashdesksessionpass')

        # Deleting model 'Pass'
        db.delete_table('backend_pass')
    ...
    models = {
        ...
        'backend.cashdesksessionpass': {
            'Meta': {'object_name': 'CashdeskSessionPass'},
            'after_session': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'before_session': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pass_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['backend.Pass']"}),
