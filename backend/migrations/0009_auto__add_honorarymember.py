...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HonoraryMember'
        db.create_table('backend_honorarymember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('membership_numer', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('full_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('backend', ['HonoraryMember'])


    def backwards(self, orm):
        # Deleting model 'HonoraryMember'
        db.delete_table('backend_honorarymember')
