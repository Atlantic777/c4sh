...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.preorder_sold'
        db.add_column('backend_ticket', 'preorder_sold',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.preorder_sold'
        db.delete_column('backend_ticket', 'preorder_sold')
