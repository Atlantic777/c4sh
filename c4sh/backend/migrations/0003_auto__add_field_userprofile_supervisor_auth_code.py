...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.supervisor_auth_code'
        db.add_column('backend_userprofile', 'supervisor_auth_code',
                      self.gf('django.db.models.fields.CharField')(max_length=64, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.supervisor_auth_code'
        db.delete_column('backend_userprofile', 'supervisor_auth_code')
