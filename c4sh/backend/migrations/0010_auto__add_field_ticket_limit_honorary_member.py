...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.limit_honorary_member'
        db.add_column('backend_ticket', 'limit_honorary_member',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.limit_honorary_member'
        db.delete_column('backend_ticket', 'limit_honorary_member')
