...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('backend_userprofile', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.created_by'
        db.delete_column('backend_userprofile', 'created_by_id')
