...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CashdeskSession.cashier_has_ended'
        db.add_column('backend_cashdesksession', 'cashier_has_ended',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CashdeskSession.cashier_has_ended'
        db.delete_column('backend_cashdesksession', 'cashier_has_ended')
    ...
    models = {
        ...
        'backend.cashdesksession': {
            ...
            'cashier_has_ended': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'backend.honorarymember': {
            'Meta': {'ordering': "['membership_number']", 'object_name': 'HonoraryMember'},
