...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cashdesk.receipt_printer_name'
        db.add_column('backend_cashdesk', 'receipt_printer_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cashdesk.receipt_printer_name'
        db.delete_column('backend_cashdesk', 'receipt_printer_name')
