...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalePosition.honorary_member'
        db.add_column('desk_saleposition', 'honorary_member',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.HonoraryMember'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SalePosition.honorary_member'
        db.delete_column('desk_saleposition', 'honorary_member_id')
    ...
    models = {
        ...
        'backend.honorarymember': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'membership_numer': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'backend.ticket': {
        ...
        'desk.sale': {
            ...
            'reversed_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'authorized_reversals'", 'null': 'True', 'to': "orm['auth.User']"}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['backend.CashdeskSession']"}),
            'time': ('django.db.models.fields.DateTimeField', [], {})
        },
        'desk.saleposition': {
            'Meta': {'object_name': 'SalePosition'},
            'honorary_member': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['backend.HonoraryMember']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
