...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.reversed_by'
        db.add_column('desk_sale', 'reversed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='authorized_reversals', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.reversed_by'
        db.delete_column('desk_sale', 'reversed_by_id')
