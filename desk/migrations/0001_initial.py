...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SalePosition'
        db.create_table('desk_saleposition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['desk.Sale'])),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.Ticket'])),
            ('sale_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('invoice_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('tax_rate', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('rabate_rate', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('supervisor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='authorized_positions', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('desk', ['SalePosition'])

        # Adding model 'Sale'
        db.create_table('desk_sale', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.CashdeskSession'])),
            ('cached_sum', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
        ...
        db.send_create_signal('desk', ['Sale'])


    def backwards(self, orm):
        # Deleting model 'SalePosition'
        db.delete_table('desk_saleposition')

        # Deleting model 'Sale'
        db.delete_table('desk_sale')
